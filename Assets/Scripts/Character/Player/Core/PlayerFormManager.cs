...
public class PlayerFormManager : MonoBehaviour
{
    ...
    private Mado.AnimationSystem.CharacterSpriteAnimator customAnimator; // [New]
    ...
    private void Awake()
    {
        ...
        customAnimator = GetComponentInChildren<Mado.AnimationSystem.CharacterSpriteAnimator>();
    ...
    {
        if (customAnimator != null && ActiveFormData != null && ActiveFormData.animationSet != null)
        {
            customAnimator.SetAnimationSet(ActiveFormData.animationSet);
        }
    }
}
